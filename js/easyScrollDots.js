...
let dotFixedNavPresent = true;
let dotFixedNavId = '.navbar-container';
...
function easyScrollDots(dotfixedOptions) {
    ...
    dotfixedOptions.fixedNavId === 'navbar-container' ? dotFixedNavId = false : dotFixedNavId = dotfixedOptions.fixedNavId;
    dotfixedOptions.fixedNavUpward === false ? dotFixedNavUp = true : dotFixedNavUp;
